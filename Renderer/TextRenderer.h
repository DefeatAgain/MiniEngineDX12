...
namespace TextRenderer
{
    ...
    inline TextContext* gTextContext = nullptr;
...
public:
    ...
    void EnableDropShadow(bool enable, CommandList& commandList);
    ...
    CommandList* RenderTask(CommandList* commandList, BOOL enableHDR);
...
private:
    ...
    void SetRenderState(GraphicsCommandList& commandList);
